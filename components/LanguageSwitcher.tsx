  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        className={`flex items-center justify-center rounded-full border border-charcoal/12 hover:border-charcoal/25 transition-colors duration-200 font-sans font-medium text-charcoal/70 hover:text-charcoal ${
          compact ? 'w-8 h-8 text-[11px]' : 'px-3 h-8 text-[12px] gap-1'
        }`}
      >
        {current.label}
      </button>
